...
class Player(pygame.sprite.Sprite):
    ...
    #     pont = pygame.sprite.spritecollide(self, self.game.coin, False)
    #     if pont:
    #         self.kill()
    #         self.game.playing = False
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.max_travel = random.randint(30, 35) #7 60
...
class WallVer(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.terrain_spritesheet.get_sprite(0, 817, self.width, 104)

        self.rect = self.image.get_rect()
        self.rect.x = self.x
        self.rect.y = self.y

class WallHor(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.bush.get_sprite(3, 0, 91, 41)
...
class Coin(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.coin.get_sprite(2, 2, 21, 21)
